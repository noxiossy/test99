...
void rewarding_state_events::init()
{
	...
	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_death_count, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 0),
			add_and_condition(
				add_accumm_value_condition(acpv_my_team_win_score, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1),
				add_and_condition(
					add_accumm_value_condition(acpv_command_switch_count, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 0),
					add_accumm_value_condition(acpv_spots, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 15)
				)
			)
		),
		1,
		eGameIDTeamDeathmatch | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_paranoia
	);

	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_my_team_win_score, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1),
			add_accumm_value_condition(acpv_enemy_top_player_div, float_bfunc_cf::get_function(float_bfunc_cf::tt_greater_equal), 2.0f)
		),
		1,
		eGameIDTeamDeathmatch,
		gamespy_profile::at_award_overwhelming_superiority
	);

	add_event(
		add_accumm_value_condition(acpv_blitzkrieg_time, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 180000),
		1,
		eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_blitzkrieg
	);

	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_artdeliver_count, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1),
			add_and_condition(
				add_accumm_value_condition(acpv_my_team_win_score, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 10),
				add_accumm_value_condition(acpv_enemy_team_score, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 0)
			)
		),
		1,
		eGameIDCaptureTheArtefact | eGameIDArtefactHunt,
		gamespy_profile::at_award_dry_victory
	);
	...
	add_event(
		...
		1,
		eGameIDCaptureTheArtefact | eGameIDArtefactHunt,
		gamespy_profile::at_award_multichampion
	);
	...
	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_faster_than_bullets_time, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 3000),
	...
	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_double_shot_double_kill_time, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 1000),
	...
	add_event(
		add_accumm_value_condition(acpv_climber, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 4),
		1,
		eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_climber
	);
	...
	add_event(
		add_and_condition(
			add_kill_condition_dist(1, ammunition_group::gid_any, KT_HIT, SKT_HEADSHOT, 0),
			add_and_condition(
				add_accumm_value_condition(acpv_move_velocity, float_bfunc_cf::get_function(float_bfunc_cf::tt_greater_equal), 6.0f),
				add_accumm_value_condition(acpv_move_ang_velocity, float_bfunc_cf::get_function(float_bfunc_cf::tt_greater_equal), 10.0f)
			)
		),
		1,
		eGameIDDeathmatch | eGameIDTeamDeathmatch | eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
	...
	add_event(
		add_accumm_value_condition(acpv_ambassador, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1),
		1,
		eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_peace_ambassador
	);
	...
	add_event(
		add_accumm_value_condition(acpv_avenger, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 3),
		1,
		eGameIDTeamDeathmatch | eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_avenger
	);

	add_event(
		add_accumm_value_condition(acpv_cherub_ready, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 2),
		1,
		eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_cherub
	);

	add_event(
		add_and_condition(
			add_and_condition(
				add_accumm_value_condition(acpv_enemy_team_score_now, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 5),
				add_accumm_value_condition(acpv_artdeliver_count, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1)
			),
			add_accumm_value_condition(acpv_my_team_win_score_now, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 1)
		),
		1,
		eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_dignity
	);
	...
	add_event(
		...
		1,
		eGameIDArtefactHunt,
		gamespy_profile::at_award_stalker_flair
	);
	...
	add_event(
		add_accumm_value_condition(acpv_black_list, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 8),
		1,
		eGameIDArtefactHunt | eGameIDCaptureTheArtefact,
		gamespy_profile::at_award_black_list
	);

	add_event(
		add_and_condition(
			add_accumm_value_condition(acpv_thunder_count, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_less_equal), 0),
			add_and_condition(
				add_accumm_value_condition(acpv_my_team_win_score, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 1),
				add_accumm_value_condition(acpv_spots, u32_bfunc_cf::get_function(u32_bfunc_cf::tt_greater_equal), 15)
			)
