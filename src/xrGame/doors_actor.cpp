...
actor::actor						( CAI_Stalker const& object ) :
	m_object					( object )
{
}
...
public:
	inline			passed_doors_predicate	(
			stalker_movement_manager_smart_cover const& movement,
			actor& actor,
		...
		m_actor					( &actor ),
		m_state					( state ),
		m_danger_distance		( danger_distance )
	{
	}
