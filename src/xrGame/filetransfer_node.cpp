...
{
	u32 size_to_write	= (static_cast<u32>(m_reader->elapsed()) >= chunk_size) ? 
		chunk_size : m_reader->elapsed();
...
bool memory_reader::is_first_packet()
{
	return !m_reader->tell();
}
...
bool memory_writer_reader::is_first_packet()
{
