...
#ifndef _ATLAS_STALKERCS_V1_H_
#define _ATLAS_STALKERCS_V1_H_
...
#define STAT_AwardAchillesHeel 24  // [TYPE: int]
#define STAT_AwardAchillesHeelLastRewardDate 25  // [TYPE: int]
#define STAT_AwardAvenger 56  // [TYPE: int]
#define STAT_AwardAvengerLastRewardDate 57  // [TYPE: int]
#define STAT_AwardBlackList 66  // [TYPE: int]
#define STAT_AwardBlackListLastRewardDate 67  // [TYPE: int]
#define STAT_AwardBlitzkrieg 16  // [TYPE: int]
#define STAT_AwardBlitzkriegLastRewardDate 17  // [TYPE: int]
#define STAT_AwardCherub 58  // [TYPE: int]
#define STAT_AwardCherubLastRewardDate 59  // [TYPE: int]
#define STAT_AwardClimber 34  // [TYPE: int]
#define STAT_AwardClimberLastRewardDate 35  // [TYPE: int]
#define STAT_AwardDeadlyAccuracy 52  // [TYPE: int]
#define STAT_AwardDeadlyAccuracyLastRewardDate 53  // [TYPE: int]
#define STAT_AwardDignity 60  // [TYPE: int]
#define STAT_AwardDignityLastRewardDate 61  // [TYPE: int]
#define STAT_AwardDoubleShotDoubleKill 32  // [TYPE: int]
#define STAT_AwardDoubleShotDoubleKillLastRewardDate 33  // [TYPE: int]
#define STAT_AwardDryVictory 18  // [TYPE: int]
#define STAT_AwardDryVictoryLastRewardDate 19  // [TYPE: int]
#define STAT_AwardFasterThanBullets 26  // [TYPE: int]
#define STAT_AwardFasterThanBulletsLastRewardDate 27  // [TYPE: int]
#define STAT_AwardHarvestTime 28  // [TYPE: int]
#define STAT_AwardHarvestTimeLastRewardDate 29  // [TYPE: int]
#define STAT_AwardInvincibleFury 40  // [TYPE: int]
#define STAT_AwardInvincibleFuryLastRewardDate 41  // [TYPE: int]
#define STAT_AwardLightingReflexes 44  // [TYPE: int]
#define STAT_AwardLightingReflexesLastRewardDate 45  // [TYPE: int]
#define STAT_AwardLucky 64  // [TYPE: int]
#define STAT_AwardLuckyLastRewardDate 65  // [TYPE: int]
#define STAT_AwardMad 22  // [TYPE: int]
#define STAT_AwardMadLastRewardDate 23  // [TYPE: int]
#define STAT_AwardMarksman 48  // [TYPE: int]
#define STAT_AwardMarksmanLastRewardDate 49  // [TYPE: int]
#define STAT_AwardMasscare 10  // [TYPE: int]
#define STAT_AwardMasscareLastRewardDate 11  // [TYPE: int]
#define STAT_AwardMultichampion 20  // [TYPE: int]
#define STAT_AwardMultichampionLastRewardDate 21  // [TYPE: int]
#define STAT_AwardOculist 42  // [TYPE: int]
#define STAT_AwardOculistLastRewardDate 43  // [TYPE: int]
#define STAT_AwardOpener 36  // [TYPE: int]
#define STAT_AwardOpenerLastRewardDate 37  // [TYPE: int]
#define STAT_AwardOwerwhelmingSuperiority 14  // [TYPE: int]
#define STAT_AwardOwerwhelmingSuperiorityLastRewardDate 15  // [TYPE: int]
#define STAT_AwardParanoia 12  // [TYPE: int]
#define STAT_AwardParanoiaLastRewardDate 13  // [TYPE: int]
#define STAT_AwardPeaceAmbassador 50  // [TYPE: int]
#define STAT_AwardPeaceAmbassadorLastRewardDate 51  // [TYPE: int]
#define STAT_AwardRemembrance 54  // [TYPE: int]
#define STAT_AwardRemembranceLastRewardDate 55  // [TYPE: int]
#define STAT_AwardSilentDeath 68  // [TYPE: int]
#define STAT_AwardSilentDeathLastRewardDate 69  // [TYPE: int]
#define STAT_AwardSkewer 30  // [TYPE: int]
#define STAT_AwardSkewerLastRewardDate 31  // [TYPE: int]
#define STAT_AwardSprinterStopper 46  // [TYPE: int]
#define STAT_AwardSprinterStopperLastRewardDate 47  // [TYPE: int]
#define STAT_AwardStalkerFlair 62  // [TYPE: int]
#define STAT_AwardStalkerFlairLastRewardDate 63  // [TYPE: int]
#define STAT_AwardToughy 38  // [TYPE: int]
#define STAT_AwardToughyLastRewardDate 39  // [TYPE: int]
#define STAT_BestScore_BackstabsKillsInRow 5  // [TYPE: int]
#define STAT_BestScore_BleedKillsInRow 8  // [TYPE: int]
#define STAT_BestScore_ExplosiveKillsInRow 9  // [TYPE: int]
#define STAT_BestScore_EyeKillsInRow 7  // [TYPE: int]
#define STAT_BestScore_HeadshotsKillsInRow 6  // [TYPE: int]
#define STAT_BestScore_KillsInRow 3  // [TYPE: int]
#define STAT_BestScore_KnifeKillsInRow 4  // [TYPE: int]
