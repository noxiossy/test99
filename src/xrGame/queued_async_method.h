...
struct parameters_tuple0
{
	...
	parameters_tuple0 &	operator =	(parameters_tuple0 const & copy)
	{
		return *this;
	}

	bool				operator == (parameters_tuple0 const & right) const
	{
		return true;
	}
...
struct parameters_tuple1
{
	parameters_tuple1()
	{}
	parameters_tuple1(T1 t1) :
		m_t1(t1)
	{};
	parameters_tuple1(parameters_tuple1 const & copy) :
		m_t1(copy.m_t1)
	{};
	...
	bool				operator == (parameters_tuple1 const & right) const
	{
...
struct parameters_tuple2
{
	parameters_tuple2()
	{}
	parameters_tuple2(T1 t1, T2 t2) :
		m_t1(t1),
		m_t2(t2)
	{};
	parameters_tuple2(parameters_tuple2 const & copy) :
		m_t1(copy.m_t1),
		m_t2(copy.m_t2)
	{};
	...
	bool				operator == (parameters_tuple2 const & right) const
	{
		return (m_t1 == right.m_t1) && (m_t2 == right.m_t2);
	}
...
struct parameters_tuple3
{
	parameters_tuple3()
	{}
	parameters_tuple3(T1 t1, T2 t2, T3 t3) :
		m_t1(t1),
		m_t2(t2),
		m_t3(t3)
	{};
	parameters_tuple3(parameters_tuple3 const & copy) :
		m_t1(copy.m_t1),
		m_t2(copy.m_t2),
		m_t3(copt.m_t3)
	{};
