...
{
player_state_opener::player_state_opener(game_state_accumulator* owner) :
	inherited(owner)
{
	m_opener_ready = false;
}

u32 const player_state_opener::get_u32_param()
{
	return m_opener_ready ? 1 : 0;
}

void player_state_opener::reset_game()
{
	m_opener_ready = false;
}
