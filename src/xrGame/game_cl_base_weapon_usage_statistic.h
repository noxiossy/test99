...
struct victims_table
{
	...
	victims_table& operator = (victims_table const & other) {m_data=other.m_data; return *this;}
...
struct bone_table
{
	...
	bone_table& operator = (bone_table const & other) {m_data=other.m_data; return *this;}
