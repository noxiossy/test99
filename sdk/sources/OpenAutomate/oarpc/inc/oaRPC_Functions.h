...
//
// OARPC_DECLARE_FUNC(func_name, func_id)
//

OARPC_DECLARE_FUNC(INVALID, 0)
OARPC_DECLARE_FUNC(GET_NEXT_COMMAND, 1)
OARPC_DECLARE_FUNC(GET_NEXT_OPTION, 2)
OARPC_DECLARE_FUNC(ADD_OPTION, 4)
OARPC_DECLARE_FUNC(ADD_OPTION_VALUE, 5)
OARPC_DECLARE_FUNC(ADD_BENCHMARK, 6)
OARPC_DECLARE_FUNC(ADD_RESULT_VALUE, 7)
OARPC_DECLARE_FUNC(START_BENCHMARK, 8)
OARPC_DECLARE_FUNC(DISPLAY_FRAME, 9)
OARPC_DECLARE_FUNC(END_BENCHMARK, 10)
OARPC_DECLARE_FUNC(ADD_FRAME_VALUE, 11)
OARPC_DECLARE_FUNC(SEND_SIGNAL, 12)

#undef OARPC_DECLARE_FUNC
