...
// #define OAC_TEST_MODULE(short_name)

OAC_TEST_MODULE(benchmarks)
OAC_TEST_MODULE(GetAllOptions)
OAC_TEST_MODULE(GetCurrentOptions)
OAC_TEST_MODULE(RunBenchmark)
OAC_TEST_MODULE(SetOptions)

#undef OAC_TEST_MODULE
