...
// #define OAC_OP_MACRO(type) 

OAC_OP_MACRO(OA_COMP_OP_INVALID)
OAC_OP_MACRO(OA_COMP_OP_EQUAL)
OAC_OP_MACRO(OA_COMP_OP_NOT_EQUAL)
OAC_OP_MACRO(OA_COMP_OP_GREATER)
OAC_OP_MACRO(OA_COMP_OP_LESS)
OAC_OP_MACRO(OA_COMP_OP_GREATER_OR_EQUAL)
OAC_OP_MACRO(OA_COMP_OP_LESS_OR_EQUAL)
